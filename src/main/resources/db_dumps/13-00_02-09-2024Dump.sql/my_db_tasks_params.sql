...
CREATE TABLE `tasks_params` (
  ...
  CONSTRAINT `task_sample_id` FOREIGN KEY (`task_sample_id`) REFERENCES `tasks_samples` (`id`) ON DELETE CASCADE
...
INSERT INTO `tasks_params` VALUES (29,'param1',1,1),(30,'param2',1,0),(36,'par 1',10,0);
