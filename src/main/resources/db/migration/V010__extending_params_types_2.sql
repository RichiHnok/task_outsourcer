...
INSERT INTO `task_sample` VALUES (1,'Рендер картинки в Blender','Это задача нужна для рендера картинки в блендер-проекте. В параметрах укажите размеры картинки, имя блендер-проекта с расширением и название итоговой картинки.','src\\main\\resources\\files\\samples\\sample1\\script.py'),(8,'script 5','Description of script 5','src\\main\\resources\\files\\samples\\sample8\\script.py'),(10,'script 3','Description of script 3',NULL),(11,'Проверка работы на txt-файле','','src\\main\\resources\\files\\samples\\sample11\\Generate numbers.py'),(12,'Задача, выполняющийся указанное количество времени','Тестовая задача для проверки работы выполнения долгих задач, которая также принимает параметр','src\\main\\resources\\files\\samples\\sample12\\Generate numbers and sleep.py');
...
INSERT INTO `task_sample_param` VALUES (29,1,'resX',0),(30,1,'resY',0),(39,1,'name of result file',2),(40,1,'name of file to render',2);
...
CREATE TABLE `task_sample_param_file` (
  ...
  `file_path` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`task_sample_param_id`),
...
INSERT INTO `task_to_proc` VALUES (50,'2025-03-01 05:45:30','FINISHED',11,1,''),(51,'2025-03-01 05:47:14','FINISHED',11,3,''),(52,'2025-03-01 05:47:21','FINISHED',11,3,'');
...
-- Dump completed on 2025-03-11 14:45:45
