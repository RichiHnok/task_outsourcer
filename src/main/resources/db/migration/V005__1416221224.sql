...
CREATE TABLE `task_sample` (
  ...
  `script_path` varchar(200) CHARACTER SET utf8mb3 DEFAULT NULL,
...
CREATE TABLE `task_to_proc` (
  ...
  `params` varchar(300) CHARACTER SET utf8mb3 DEFAULT NULL,
...
INSERT INTO `task_to_proc` VALUES (1,'2024-08-22 13:50:19',0,1,1,'20~30'),(2,'2024-08-22 13:51:38',0,10,3,'333'),(3,'2024-12-17 10:20:33',0,1,1,'0~0~0~0'),(4,'2024-12-17 10:21:05',0,1,1,'480~120~result~project.blend'),(5,'2024-12-17 14:56:42',0,1,1,'4~2~r~i'),(6,'2024-12-17 15:03:19',0,1,1,'4~1~o~i'),(7,'2024-12-17 15:06:37',0,1,1,'480~120~rendered~project.blend'),(8,'2024-12-17 20:38:03',0,1,1,'480~120~rendered~project.blend'),(9,'2024-12-18 16:16:26',0,1,1,'480~120~rendered-scene~project.blend');
...
CREATE TABLE `users` (
  ...
  `login` varchar(45) CHARACTER SET utf8mb3 NOT NULL,
  `name` varchar(100) CHARACTER SET utf8mb3 NOT NULL,
  `surname` varchar(100) CHARACTER SET utf8mb3 NOT NULL,
  `password` varchar(100) CHARACTER SET utf8mb3 NOT NULL,
  `email` varchar(45) CHARACTER SET utf8mb3 DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'R','Richi','Hnok','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq',NULL,5,120),(3,'A','Artemiy','Viazovski','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq',NULL,5,60),(4,'ap','Arkadiy','Porovozov','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq',NULL,5,60);
...
-- Dump completed on 2024-12-22 14:16:33
