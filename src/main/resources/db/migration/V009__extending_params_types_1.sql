...
INSERT INTO `task_sample_param` VALUES (29,1,'resX',0),(30,1,'resY',0),(36,10,'par 1',0),(39,1,'name of result file',2),(40,1,'name of file to render',2);
...
CREATE TABLE `task_sample_param_file` (
  ...
  `file_path` varchar(300) CHARACTER SET utf8mb3 NOT NULL,
  PRIMARY KEY (`task_sample_param_id`),
...
-- Dump completed on 2025-03-09 14:11:08
