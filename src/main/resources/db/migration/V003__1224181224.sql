...
INSERT INTO `flyway_schema_history` VALUES (1,'1','<< Flyway Baseline >>','BASELINE','<< Flyway Baseline >>',NULL,'bestuser','2024-12-18 04:47:16',0,1),(2,'002','test insert','SQL','V002__test_insert.sql',1990482650,'bestuser','2024-12-18 04:54:59',22,1);
...
INSERT INTO `task_sample` VALUES (1,'Рендер картинки в Blender','Description of script 1','src\\main\\resources\\files\\samples\\sample1\\script.py'),(8,'script 5','Description of script 5','src\\main\\resources\\files\\samples\\sample8\\script.py'),(10,'script 3','Description of script 3',NULL);
...
INSERT INTO `users` VALUES (1,'R','Richi','Hnok','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq',NULL,5,120),(3,'A','Artemiy','Viazovski','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq',NULL,5,60),(4,'ap','Arkadiy','Porovozov','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq',NULL,5,60),(6,'B','B','B','$2a$05$BCQjpjA.bxcytp4Z2cgmBOzQyoi.N0LAgTfoAmx5feWrfMepI6c3S','a@a.c',5,60),(7,'C','C','C','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq','a@a.c',5,60),(8,'C','C','C','$2a$05$Jy9ysQVWGuwfplxJ9NUfb.S6bjysR7m/19YI6A7UOMONcnei8HPSq','a@a.c',5,60);
...
-- Dump completed on 2024-12-18 12:24:05
